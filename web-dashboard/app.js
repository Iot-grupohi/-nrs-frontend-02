...
// Função para inicializar o app após Firebase estar pronto
async function initializeApp() {
    ...
    try {
        ...
        console.error('Erro ao inicializar app.js:', error);
        throw error;
    }
}
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        // Aguarda inicialização do Firebase e do banco de dados
        console.log('Aguardando inicialização do Firebase...');
        await initializeApp();
        console.log('Firebase inicializado, iniciando carregamento da aplicação...');
