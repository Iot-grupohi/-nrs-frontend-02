// Referência ao banco de dados do Firebase - será inicializada quando o Firebase estiver pronto
let database = null;

// Função para inicializar referências do Firebase
...
// Verifica se o ID da loja foi fornecido (validação inicial)
if (!lojaId) {
    window.location.href = 'index.html';
}
