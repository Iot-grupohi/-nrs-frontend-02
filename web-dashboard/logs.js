...
// Referência à coleção no Firestore - será inicializada quando o Firebase estiver pronto
let operacoesRef = null;

// Função para inicializar referências do Firestore
async function initFirestoreRefs() {
    if (!operacoesRef) {
        await window.waitForFirebase();
        operacoesRef = firebase.firestore().collection('operacoes_logs');
    }
    return operacoesRef;
}
