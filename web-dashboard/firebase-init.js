...
// Nota: Firebase API keys são públicos por design (ver: https://firebase.google.com/docs/projects/api-keys)
// A segurança é garantida pelas Firebase Security Rules, não pela obscuridade das keys
